...
- **Environment Variables:**
  ```
  NODE_ENV=production
  DATABASE_URL=postgresql://master_order_user:your_secure_password_here@192.168.1.119:5432/master_order
  POSTGRES_PASSWORD=your_secure_password_here
...
**Important:** Update the `EXTERNAL_IP` environment variable to match your Unraid server's actual IP address for Android companion app compatibility.
