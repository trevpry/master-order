...
INSERT INTO "new_Settings" ("collectionName", "comicVineApiKey", "createdAt", "customOrderPercent", "id", "moviesGeneralPercent", "plexSyncInterval", "plexToken", "plexUrl", "tvGeneralPercent", "tvdbApiKey", "tvdbBearerToken", "tvdbToken", "tvdbTokenExpiry", "updatedAt") SELECT "collectionName", "comicVineApiKey", "createdAt", "customOrderPercent", "id", "moviesGeneralPercent", "plexSyncInterval", "plexToken", "plexUrl", "tvGeneralPercent", "tvdbApiKey", "tvdbBearerToken", "tvdbToken", "tvdbTokenExpiry", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
