...
INSERT INTO "new_Settings" ("christmasFilterEnabled", "collectionName", "comicVineApiKey", "createdAt", "customOrderPercent", "id", "ignoredMovieCollections", "ignoredTVCollections", "komgaApiKey", "komgaUrl", "moviesGeneralPercent", "partiallyWatchedCollectionPercent", "plexSyncInterval", "plexToken", "plexUrl", "selectedPlayer", "selectedPlexUser", "stashApiKey", "stashSyncInterval", "stashUrl", "timezone", "tvGeneralPercent", "tvdbApiKey", "tvdbBearerToken", "tvdbToken", "tvdbTokenExpiry", "updatedAt") SELECT "christmasFilterEnabled", "collectionName", "comicVineApiKey", "createdAt", "customOrderPercent", "id", "ignoredMovieCollections", "ignoredTVCollections", "komgaApiKey", "komgaUrl", "moviesGeneralPercent", "partiallyWatchedCollectionPercent", "plexSyncInterval", "plexToken", "plexUrl", "selectedPlayer", "selectedPlexUser", "stashApiKey", "stashSyncInterval", "stashUrl", "timezone", "tvGeneralPercent", "tvdbApiKey", "tvdbBearerToken", "tvdbToken", "tvdbTokenExpiry", "updatedAt" FROM "Settings";
DROP TABLE "Settings";
