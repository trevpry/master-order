...
INSERT INTO "new_HistoryVideo" ("assignLater", "channelId", "courseTitle", "createdAt", "description", "duration", "eventId", "id", "lectureNumber", "publishedAt", "status", "thumbnailUrl", "title", "type", "updatedAt", "url") SELECT "assignLater", "channelId", "courseTitle", "createdAt", "description", "duration", "eventId", "id", "lectureNumber", "publishedAt", "status", "thumbnailUrl", "title", "type", "updatedAt", "url" FROM "HistoryVideo";
