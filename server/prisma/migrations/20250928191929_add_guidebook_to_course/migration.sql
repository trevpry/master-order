/*
  ...
  - You are about to drop the column `courseId` on the `HistoryVideo` table. All the data in the column will be lost.

*/
-- AlterTable
ALTER TABLE "HistoryCourse" ADD COLUMN "guidebook" TEXT;
...
INSERT INTO "new_HistoryVideo" ("assignLater", "assignedByAI", "channelId", "courseTitle", "createdAt", "deleted", "description", "duration", "eventId", "id", "lectureNumber", "publishedAt", "status", "thumbnailUrl", "title", "type", "updatedAt", "url") SELECT "assignLater", "assignedByAI", "channelId", "courseTitle", "createdAt", "deleted", "description", "duration", "eventId", "id", "lectureNumber", "publishedAt", "status", "thumbnailUrl", "title", "type", "updatedAt", "url" FROM "HistoryVideo";
