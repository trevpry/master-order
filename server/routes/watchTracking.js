...
router.post('/mark-media-watched', asyncHandler(async (req, res) => {
...
router.post('/watch-logs', asyncHandler(async (req, res) => {
...
router.delete('/watch-logs/:id', asyncHandler(async (req, res) => {
  const { id } = req.params;
...
router.post('/debug/fix-webvideo-completion', asyncHandler(async (req, res) => {
